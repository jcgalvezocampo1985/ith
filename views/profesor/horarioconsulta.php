                                ...
                                <td>
                                    <div class="btn-group dropleft">
                                        ...
                                        <ul class="dropdown-menu  pull-right">
                                            ...
                                            <li><?= Html::a("Capturar Calificaciones S1", ["profesor/listaalumnoscalificacionseguimientosadmin?idgrupo=".$row["idgrupo"]."&idciclo=".$idciclo."&idprofesor=".$idprofesor."&ultimo_ciclo=".$ultimo_ciclo."&r=false&seguimiento=1"], ["target" => "_parent"]) ?></li>
